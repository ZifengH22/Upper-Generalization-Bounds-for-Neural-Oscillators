...
class Args: 
    def __init__(self, seed = seed) -> None:  
        ...
        # Epoch
        self.epochs = 3000
        self.time_length = 3000
        self.Sample_size = 800
        
        # file path
        self.data_path = r'data/' 
        self.model_data_path = 'Data_path_time_length_'+str(self.time_length) + '_' + str(seed) + '_' + str(self.Sample_size) +'/data/'
        self.modelsave_path = 'Data_path_time_length_'+str(self.time_length) + '_' + str(seed) + '_' + str(self.Sample_size) + '/Results/'
...
E_X_pred_dict = {'E_X_pred_'+str(args.time_length) + '_' + str(seed) + '_' + str(args.Sample_size):E_X_pred} 
scipy.io.savemat(args.data_path + 'E_X_pred_'+str(args.time_length)+ '_' + str(seed) + '_' + str(args.Sample_size) +'.mat', E_X_pred_dict) 
