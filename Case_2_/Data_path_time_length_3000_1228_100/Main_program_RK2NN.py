...
def train_RK4PIGRU_main(args):
    ...
    Train_epochs_loss_1 = {'Train_epochs_loss_1'+ '_' + str(seed) + '_' + str(sample_size):train_epochs_loss_1}
    Train_epochs_loss_2 = {'Train_epochs_loss_2'+ '_' + str(seed) + '_' + str(sample_size):train_epochs_loss_2}
    Train_epochs_loss = {'Train_epochs_loss'+ '_' + str(seed) + '_' + str(sample_size):train_epochs_loss}
    Val_epochs_loss = {'Val_epochs_loss'+ '_' + str(seed) + '_' + str(sample_size):val_epochs_loss}
    scipy.io.savemat(data_path + 'Train_epochs_loss_1'+ '_' + str(seed) + '_' + str(sample_size) +'.mat', Train_epochs_loss_1)
    scipy.io.savemat(data_path + 'Train_epochs_loss_2'+ '_' + str(seed) + '_' + str(sample_size) +'.mat', Train_epochs_loss_2)
    scipy.io.savemat(data_path + 'Train_epochs_loss'+ '_' + str(seed) + '_' + str(sample_size) +'.mat', Train_epochs_loss)
    scipy.io.savemat(data_path + 'Val_epochs_loss'+ '_' + str(seed) + '_' + str(sample_size) +'.mat', Val_epochs_loss)

    ###derivative norm
    RK4GRUcell_derivative_norm = np.array(RK4GRUcell_derivative_norm)
    top_DNN_derivative_norm = np.array(top_DNN_derivative_norm)
    
    RK4GRUcell_derivative_norm_file = {'RK4GRUcell_derivative_norm'+ '_' + str(seed) + '_' + str(sample_size):RK4GRUcell_derivative_norm}
    top_DNN_derivative_norm_file = {'top_DNN_derivative_norm'+ '_' + str(seed) + '_' + str(sample_size):top_DNN_derivative_norm}
    scipy.io.savemat(data_path + 'RK4GRUcell_derivative_norm'+ '_' + str(seed) + '_' + str(sample_size) +'.mat', RK4GRUcell_derivative_norm_file)
    scipy.io.savemat(data_path + 'top_DNN_derivative_norm'+ '_' + str(seed) + '_' + str(sample_size) +'.mat', top_DNN_derivative_norm_file)
