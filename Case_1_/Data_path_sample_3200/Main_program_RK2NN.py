...
def load_matdata_train(args,seed):
    ...
    return F_input_train, X_dX_input_train, X_dX_output_train, t_train
...
def train_RK4PIGRU_main(args):
    ...
    F_input, X_dX_input, X_dX_output, t_input = load_matdata_train(args,seed) 
