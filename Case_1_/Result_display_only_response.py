...
class Args: 
    def __init__(self) -> None:  
        ...
        self.model_data_path = 'Data_path_sample_'+str(self.Sample_size)+'/data/'
        self.modelsave_path = 'Data_path_sample_'+str(self.Sample_size)+'/Results/'
...
X_pred_dict = {'X_pred_'+ str(args.Sample_size) + '_' + str(seed):X_pred} 
scipy.io.savemat(args.data_path + 'X_pred_'+ str(args.Sample_size) + '_' + str(seed)+'.mat', X_pred_dict) 
