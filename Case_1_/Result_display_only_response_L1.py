...
class Args: 
    def __init__(self) -> None:  
        ...
        self.model_data_path = 'Data_path_sample_'+str(self.Sample_size) + '_L1' +'/data/'
        self.modelsave_path = 'Data_path_sample_'+str(self.Sample_size) + '_L1' +'/Results/'
...
def load_matdata(args,seed):
    ...
    data_path_X = args.data_path + 'X1_response.mat'
...
# test model
args = Args()
_, _, _, _, t_train, Acc_test, X_test, _  = load_matdata(args,seed)
...
num_input_layer_F = test_exc.shape[2]
...
X_pred_dict = {'X_pred_'+ str(args.Sample_size) + '_' + str(seed) + '_L1':X_pred} 
scipy.io.savemat(args.data_path + 'X_pred_'+ str(args.Sample_size) + '_' + str(seed)+ '_L1' +'.mat', X_pred_dict) 
