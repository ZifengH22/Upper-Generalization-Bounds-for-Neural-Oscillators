...
def train_RK4PIGRU_main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for idx, (Exc,SVi_delay, SVjtarget,T_time) in enumerate(train_dataloader):           
            ...
            if (loss_1.item() < smallest_loss_1):
                ...
                SVj_smallest_1 = SVj.detach().cpu().numpy()
            ...
            if epoch == 0 or epoch == 50 or epoch == 100 or epoch == 1000 or epoch == args.epochs-1:
                ...
                SVj_smallest_temp = SVj_smallest_temp.detach().cpu().numpy()
    ...
    RK4GRUcell_derivative_norm_file = {'RK4GRUcell_derivative_norm':RK4GRUcell_derivative_norm}
    top_DNN_derivative_norm_file = {'top_DNN_derivative_norm':top_DNN_derivative_norm}
    scipy.io.savemat(data_path + 'RK4GRUcell_derivative_norm'+'.mat', RK4GRUcell_derivative_norm_file)
    scipy.io.savemat(data_path + 'top_DNN_derivative_norm'+'.mat', top_DNN_derivative_norm_file)
