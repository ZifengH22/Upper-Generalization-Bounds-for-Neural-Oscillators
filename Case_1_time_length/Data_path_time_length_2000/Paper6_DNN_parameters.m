...
load([Data_path,'W_top_DNN1.mat'])
load([Data_path,'W_top_DNNe.mat'])
load([Data_path,'B_top_DNN0.mat'])
load([Data_path,'B_top_DNN1.mat'])
...
Lip_4 = sum(sum(W_top_DNN1.^2)) + sum(sum(B_top_DNN1.^2));
Lip_5 = sum(sum(W_top_DNNe.^2)) + sum(sum(B_top_DNNe.^2));
Lip = ((Lip_1*Lip_2)^0.5+1)^2*Lip_3*Lip_4*Lip_5;
...
L1_4 = sum(sum(abs(W_top_DNN1))) + sum(sum(abs(B_top_DNN1)));
L1_5 = sum(sum(abs(W_top_DNNe))) + sum(sum(abs(B_top_DNNe)));
L1 = L1_1+L1_2+L1_3+L1_4+L1_5;

L1_W_1 = sum(sum(abs(W_RK4GRUcell0)));
L1_W_2 = sum(sum(abs(W_RK4GRUcelle)));
L1_W_3 = sum(sum(abs(W_top_DNN0)));
L1_W_4 = sum(sum(abs(W_top_DNN1)));
L1_W_5 = sum(sum(abs(W_top_DNNe)));
L1_W = L1_W_1+L1_W_2+L1_W_3+L1_W_4+L1_W_5;
...
L2_4 = sum(sum(W_top_DNN1.^2)) + sum(sum(B_top_DNN1.^2));
L2_5 = sum(sum(W_top_DNNe.^2)) + sum(sum(B_top_DNNe.^2));
L2 = L2_1+L2_2+L2_3+L2_4+L2_5;

Lmax_1_W1 = max(max(abs(W_RK4GRUcell0))); 
Lmax_1_B1 = max(max(abs(B_RK4GRUcell0)));
Lmax_1_W2 = max(max(abs(W_RK4GRUcelle)));
Lmax_1_B2 = max(max(abs(B_RK4GRUcelle)));

Lmax_2_W1 = max(max(abs(W_top_DNN0)));
Lmax_2_B1 = max(max(abs(B_top_DNN0)));
Lmax_2_W2 = max(max(abs(W_top_DNN1)));
Lmax_2_B2 = max(max(abs(B_top_DNN1)));
Lmax_2_W3 = max(max(abs(W_top_DNNe)));
Lmax_2_B3 = max(max(abs(B_top_DNNe)));

Lmax = Lmax_1_W1 + Lmax_1_B1 + Lmax_1_W2 + Lmax_1_B2 + Lmax_2_W1 + Lmax_2_B1 + Lmax_2_W2 + Lmax_2_B2 + + Lmax_2_W3 + Lmax_2_B3
%%%%%%%%%%Lip_enhance%%%%%%%%%%
