...
# path_save_RK4GRUcell = modelsave_path + 'RK4GRUcell_smallest_1_' + str(gru_step) + '_' + str(num_sample['Sample_size'][0,0]) + '_' + str(args.epochs) + '_' + str_layers + '_' + str_top_layers + '.pth'
# path_save_topDNN = modelsave_path + 'topDNN_smallest_1_' + str(gru_step) + '_' + str(num_sample['Sample_size'][0,0]) + '_' + str(args.epochs) + '_' + str_layers + '_' + str_top_layers + '.pth'
...
for name, param in RK4GRUcell_copy.items():
    ...
    if 'bias' in name:
        ...
        file_path = data_path+para_name+'.mat'
